...
export const POPULAR_SEO_ROUTES: Record<string, SeoConversionRoute> = {
  ...
  'pdf-to-word': {
    ...
    toFormat: 'DOCX',
    category: 'document',
    title: 'Конвертер PDF в Word онлайн бесплатно — PDF в DOCX | AllConvert',
    metaDescription: 'Бесплатный онлайн конвертер PDF в Word (DOCX). Преобразуйте документы PDF в редактируемый формат Word прямо в браузере без потери качества и загрузки на сервер.',
    ...
    descriptionParagraphs: [
      'Документы PDF отлично подходят для чтения и печати, но их трудно редактировать. Перевод PDF в формат Word (DOCX) позволяет легко редактировать тексты, таблицы и структуру документа.',
